...
export const ENV = {
  ...
  FRONTEND_URL: process.env.FRONTEND_URL || 'https://compliance-qr-platform-tui9.vercel.app',
  PUBLIC_APP_URL: process.env.PUBLIC_APP_URL || process.env.FRONTEND_URL || 'https://compliance-qr-platform-tui9.vercel.app',
