...
export const ensureInitialData = async () => {
  ...
  try {
    ...
    if (!settings) {
      ...
      console.log('[AutoSeed] Default platform settings created.');
    }
    ...
    if (!admin) {
      ...
      console.log(`[AutoSeed] Platform Admin created: ${admin.username}`);
    }

    // 3. Sample Organization if none exists
    ...
    if (orgCount === 0) {
      ...
      console.log('[AutoSeed] Sample organization ABC General Hospital initialized.');
    }
